...
\begin{itemize}
  ...
  \item sequence conservation levels, which vary across the gene
\end{itemize}
\end{itemize}
...
\textbf{Rfam: RNA families database}

\end{center}

\begin{itemize}
\item 2450 families each represented by a manually curated \emph{seed}
  alignment and CM
\item Each release:
\begin{itemize}
  \item 
  each CM is used to search Rfamseq, a large (270 Gb) database derived
  from ENA (European Nucleotide Archive)
  \item 
  information on putative homologs identified is made available on Rfam website
\end{itemize}
\end{itemize}
